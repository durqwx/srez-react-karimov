            ...
            <div className={s.sort__category}>
                <div className={s.cat}>
                    ...
                    <div className={s.btns}>
                        ...
                        <buttton onClick={() => setCategory(1)} className='btn'>Гитара</buttton>
                        <buttton onClick={() => setCategory(2)} className='btn'>Рояль</buttton>
                        <buttton onClick={() => setCategory(3)} className='btn'>Баян</buttton>
                    </div>
                </div>
